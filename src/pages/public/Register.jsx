...
export default function Register() {
  const [form, setForm] = useState({
    fullName: '', email: '', phone: '', province: '', city: '', barangay: '', language: '', consent: false,
  });

  const set = (k, v) => setForm(prev => ({ ...prev, [k]: v }));

  // Base44 handles actual registration — redirect to login which handles the OAuth flow
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="space-y-1">
                  ...
                  <Input placeholder="As shown on your government ID" value={form.fullName} onChange={e => set('fullName', e.target.value)} required />
                </div>
              ...
              <Button type="submit" className="w-full bg-secondary hover:bg-secondary/90" disabled={!form.consent}>
